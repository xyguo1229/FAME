...
def get_params():
    ...
    # args.add_argument("-data", "--dataset", default="ICWES18-One", type=str)  # ["NELL-One", "Wiki-One"]
    # args.add_argument("-dataset", "--dataset_1", default="ICEWS18", type=str)
    args.add_argument("-data", "--dataset", default="gdelt-few-intp-One", type=str)  # ["NELL-One", "Wiki-One"]
    args.add_argument("-dataset", "--dataset_1", default="gdelt-few-intp", type=str)
    args.add_argument("-path", "--data_path", default="./gdelt-few-intp", type=str)  # ["./NELL", "./Wiki"]
    ...
    args.add_argument("-dim", "--embed_dim", default=100, type=int)  #100
    args.add_argument("-bs", "--batch_size", default=1024, type=int)
    args.add_argument("-lr", "--learning_rate", default=0.0001, type=float)
    ...
    args.add_argument("-b", "--beta", default=0.1, type=float)
    ...
    args.add_argument("-prefix", "--prefix", default="e", type=str)
    ...
    # args.add_argument("-eval_ckpt", "--eval_ckpt", default='20000', type=str)
...
data_dir = {
    'train_tasks_in_train': '\train_tasks_in_train.json',
